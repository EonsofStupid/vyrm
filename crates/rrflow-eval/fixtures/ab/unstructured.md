...
| §3 | `promote`, `gate` | **Missing** | no `rrflow-gate` |
...
| §5 | `rrflow-gate`, `rrd-engine`, `rrflow-mcp` | **Missing** | absent |
...
surfaces compose the same crates through rrflow-gate/rrd-engine, because a
