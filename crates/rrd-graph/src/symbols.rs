...
mod tests {
    ...
    fn rust_imports_are_captured() {
        let found = extract("use rrd_core::key::claim_key;", Language::Rust);
        assert!(found
            .iter()
            .any(|o| o.role == Role::Import && o.name.contains("rrd_core")));
    }
    ...
    fn ecmascript_exports_and_imports_are_captured() {
        ...
        assert!(found
            .iter()
            .any(|o| o.role == Role::Definition && o.name == "route"));
        assert!(found
            .iter()
            .any(|o| o.role == Role::Import && o.name == "./store"));
    }
    ...
    fn tsx_components_parse_despite_jsx_syntax() {
        ...
        assert!(
            names.contains(&"Panel".to_string()),
            "JSX broke extraction: {names:?}"
        );
    }
    ...
    fn python_definitions_and_imports_are_captured() {
        ...
        assert!(
            ...
            "module-level assignment missed"
        );
        assert!(found
            .iter()
            .any(|o| o.role == Role::Import && o.name == "os"));
        assert!(found
            .iter()
            .any(|o| o.role == Role::Import && o.name == "collections"));
    }
    ...
    fn svelte_script_declarations_carry_file_line_numbers() {
        ...
        assert_eq!(
            toggle.line, 3,
            "line number not offset to the enclosing file"
        );
    }
    ...
    fn comments_do_not_produce_declarations() {
        ...
        assert!(
            found.is_empty(),
            "a commented declaration was indexed: {found:?}"
        );
    }
    ...
    fn string_literals_do_not_produce_declarations() {
        ...
        assert!(
            ...
            "a declaration inside a string was indexed"
        );
    }
