    ...
    CapabilitiesView {
        ...
        engine: vec![
            ...
            EngineCapabilityView {
                ...
                category: "vector",
                maturity: CapabilityMaturity::Partial,
                summary: "Seeded 4/2/1.5/1-bit MSE TurboQuant artifacts behind exact-f32 reranking.",
                evidence: "Deterministic codec, asymmetric scoring, authenticated binary reopen, catalogue/planner selection, corruption denial, and exact reranking pass locally.",
                limitation: "Public build/lifecycle APIs, SIMD/mmap, broad recall/bias/latency evidence, and residual QJL are not shipped.",
            },
            EngineCapabilityView {
