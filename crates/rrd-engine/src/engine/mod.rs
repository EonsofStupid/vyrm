...
use rrd_contract::{
    ...
    DataVectorValue, DeploymentMode, DiagnosticAuthority, DiagnosticCoverage,
    ...
    EnsureVectorIndex, EnsureVectorIndexResult, ExecuteFunction, ExecuteQuery,
    ExecuteQueryTransaction, ExportAudit, FollowChangefeed, ForwardRollbackCounts,
