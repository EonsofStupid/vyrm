...
use rrd_contract::{
    ...
    AuditPhase, AuditRecordSnapshot, AutomationCatalogue, BeginTransaction, CanonicalId,
    ChangeMutationSnapshot, ChangefeedFollowResult, ChangefeedPage, ChangefeedValidation,
    ClaimChangeSnapshot, ClaimPromotionSnapshot, ClaimTierSnapshot, CloseSession,
    CloseSubscription, CloseSubscriptionResult, CommitReceipt, CommitTransaction, CorrelationId,
    CreateInstanceBackup, CreateInstanceBackupResult, CreateSession, DataCatalogueIdentity,
    DataEmbeddingProvenance, DataEventSchema, DataGeoPoint, DataGeoValue, DataLogicalModel,
    DataObjectReceipt, DataProperties, DataPropertySchema, DataRecordSchema, DataReference,
    DataRelationSchema, DataSchemaMode, DataSchemaRegistry, DataSeriesValue, DataSnapshot,
    DataSnapshotEntry, DataTableSchema, DataTarget, DataValueType, DataVectorNormalization,
    DataVectorValue, DeleteVectorCollection, DeleteVectorCollectionResult,
    DeleteVectorPayloadIndex, DeleteVectorPayloadIndexResult, DeploymentMode, DiagnosticAuthority,
    ...
    QueryExecutionAnalysisSnapshot, QueryExecutionSnapshot, QueryFullTextConfiguration,
    QueryIndexCatalogueSnapshot, QueryIndexKind, QueryIndexMaintenanceSnapshot, QueryIndexSnapshot,
