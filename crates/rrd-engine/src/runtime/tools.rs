...
fn runtime_tool_operation_for_action(action: SecurityAction) -> crate::Result<RrdOperation> {
    let operation = match action {
        ...
        SecurityAction::VectorCollectionDelete => RrdOperation::VectorCollectionDelete,
        SecurityAction::VectorPayloadIndexEnsure => RrdOperation::VectorPayloadIndexEnsure,
        SecurityAction::VectorPayloadIndexList => RrdOperation::VectorPayloadIndexList,
        SecurityAction::VectorPayloadIndexDelete => RrdOperation::VectorPayloadIndexDelete,
