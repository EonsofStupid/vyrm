...
//! separate local-Raft and canonical-state domains, but deliberately no
//! production RPC. Production Multi-AZ capability remains denied until
//! authenticated transport and independent-process hardware fault evidence
//! pass the same invariants.
